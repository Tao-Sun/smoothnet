...
img0 = cv2.imread(sys.argv[1], cv2.IMREAD_COLOR)
print("img shape:" + str(img0.shape))
img1 = cv2.imread(sys.argv[2], cv2.IMREAD_COLOR)

flow = read_flow(sys.argv[3])
print("flow shape:" + str(flow.shape))
flow_img = draw_flow(img1, flow)
warped_img = warp_flow(img1, flow)
